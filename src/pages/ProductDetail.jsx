            ...
            <div className="md:flex justify-around">
              ...
              <div className=" md:w-[50vw]  md:pl-10 mx-4 md:mx-0">
                <div className=" border-b-[1px] md:pb-7 pb-4 md:mt-0 mt-3">
                  <h1 className=" uppercase mb-3 text-xl font-medium">
                    {title}
                  </h1>
                ...
                <div className="flex flex-col items-start justify-start py-4 border-b-[1px] pb-7">
                  <button
                    ...
                    className="bg-[#001e2b] hover:bg-[#001e2bdd] duration-700  w-full my-2 md:w-80 p-2 cursor-pointer text-white font-light text-lg"
                  >
                    MUA NGAY
                  </button>
                  <button
                ...
                <div className="py-4 text-sm">
                  ...
                  <p className="text-gray-600  w-full font-light text-justify">
                    ...
                    Obcaecati, et quam numquam temporibus, quae, eveniet
                    nesciunt nihil animi cumque minus molestias laborum
                    perferendis tempora. Voluptates delectus eos commodi
