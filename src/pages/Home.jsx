        ...
        <div className="md:py-10 pt-8 ">
          <div className="container mx-auto flex flex-col ">
            ...
            <div className="flex items-center justify-center">
              ...
              {  products.length === 0? <td className='absolute text-center text-xl p-3'>No  products !!!</td> : products && products.length>0 &&
                products.map((pro, index) => {
                  return (
                    <div key={index} className=" hover:shadow-xl  shadow duration-700">
