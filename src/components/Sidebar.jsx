  ...
  return (
    ...
    >
      <div className="flex items-center justify-between py-3 border-b-[1px] border-[#ccc]">
        <h1 className="flex items-center font-medium border-l-4 text-base border-rose-500 text-rose-500 pl-1">
          CART{" "}
          <img
            className=" w-9 ml-2"
        ...
        <button
          className="hover:bg-[#cccccc4f] relative w-6 h-6 flex items-center justify-center rounded-full duration-500 transition-all cursor-pointer"
          onClick={handleClose}
        >
      ...
      <div>
        <div className="flex justify-between  items-center mt-6">
          ...
          <button
            onClick={clearCart}
            className=" bg-red-500 w-10  h-10 rounded-sm text-white"
          >
            <i className="ri-delete-bin-line text-md"></i>
          </button>
        </div>

        <div className=" my-6 bg-black w-full text-md font-medium   cursor-pointer  text-white flex items-center justify-center py-3 rounded-sm">
          <button>MUA</button>
        </div>
      </div>
    </div>
