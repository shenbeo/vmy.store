...
export default function Header() {
  ...
  return (
    <header
      className={`${
        isActive
          ? " py-4 bg-[#212121d4]  shadow-lg text-white "
          : " py-4 bg-transparent"
    ...
    >
      <div className="container mx-auto flex items-center justify-between h-full w-full">
        ...
        <Link to={"/"} className="ml-4 md:ml-0">
          <div className="flex  font_logo text-sm bg-red-700 px-2 py-2 scroll-py-14 text-[#ffffff]">
            <h1 className="">V</h1>
        ...
        <div className="flex items-center justify-center">
          ...
          <div
            ...
            className="hover:bg-[#ecececeb] bg-[#b4b3b377] relative w-8 h-8 flex items-center justify-center rounded-full duration-500 transition-all cursor-pointer mx-4"
          >
            <i className="ri-shopping-bag-line font-extralight"></i>
            <div className="flex absolute items-center justify-center text-[#e9e4e4] rounded-full text-xs ml-6 mb-5 pt-1 bg-rose-500 w-4 h-4">
          ...
          <Link className="">
            ...
            <div
              ...
              className="hover:bg-[#ecececeb] bg-[#b4b3b377] mr-4 md:mr-0  w-8 h-8 flex items-center justify-center rounded-full duration-500 transition-all cursor-pointer"
            >
